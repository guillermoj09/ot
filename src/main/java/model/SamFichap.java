...
/**
 * The persistent class for the sam_fichap database table.
 * 
 */
@Entity
@Table(name="sam_fichap")
@NamedQuery(name="SamFichap.findAll", query="SELECT s FROM SamFichap s")
public class SamFichap implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="fich_codigo")
	private Integer fichCodigo;
	...
	private Integer fichCantMoviles;

	@Column(name="fich_cantidad_total")
	private Integer fichCantidadTotal;
	...
	@Column(name="fich_df")
	private Integer fichDf;

	@Column(name="fich_dia_pago")
	private Integer fichDiaPago;
	...
	private Integer fichIdClienteSf;
	...
	private Integer fichPeriodoDemo;
	...
	public Integer getFichCodigo() {
		return this.fichCodigo;
	}

	public void setFichCodigo(Integer fichCodigo) {
	...
	public Integer getFichCantMoviles() {
		return this.fichCantMoviles;
	}

	public void setFichCantMoviles(Integer fichCantMoviles) {
		this.fichCantMoviles = fichCantMoviles;
	}

	public Integer getFichCantidadTotal() {
		return this.fichCantidadTotal;
	}

	public void setFichCantidadTotal(Integer fichCantidadTotal) {
	...
	public Integer getFichContrato() {
		return this.fichContrato;
	}

	public void setFichContrato(Integer fichContrato) {
	...
	public Integer getFichDf() {
		return this.fichDf;
	}

	public void setFichDf(Integer fichDf) {
		this.fichDf = fichDf;
	}

	public Integer getFichDiaPago() {
		return this.fichDiaPago;
	}

	public void setFichDiaPago(Integer fichDiaPago) {
	...
	public Integer getFichEstado() {
		return this.fichEstado;
	}

	public void setFichEstado(Integer fichEstado) {
	...
	public Integer getFichIdClienteSf() {
		return this.fichIdClienteSf;
	}

	public void setFichIdClienteSf(Integer fichIdClienteSf) {
	...
	public Integer getFichPeriodoDemo() {
		return this.fichPeriodoDemo;
	}

	public void setFichPeriodoDemo(Integer fichPeriodoDemo) {
	...
	public Integer getFichTipcliCodigo() {
		return this.fichTipcliCodigo;
	}

	public void setFichTipcliCodigo(Integer fichTipcliCodigo) {
		this.fichTipcliCodigo = fichTipcliCodigo;
	}

	public Integer getFichTipoDemo() {
		return this.fichTipoDemo;
	}

	public void setFichTipoDemo(Integer fichTipoDemo) {
	...
	public Integer getFichUsuCodigo() {
		return this.fichUsuCodigo;
	}

	public void setFichUsuCodigo(Integer fichUsuCodigo) {
		this.fichUsuCodigo = fichUsuCodigo;
	}

	public Integer getFichUsuModifica() {
		return this.fichUsuModifica;
	}

	public void setFichUsuModifica(Integer fichUsuModifica) {
