	...
	<div id="wrapper">
							...
							<div class="ibox-content">
								<div class="row">
									<div class="col-lg-12">
										<div class="ibox">
											<div class="ibox-content">
												<form action="upload.html" class="dropzone"
													id="dropzoneForm" name="CrearTareaForm"
													enctype="multipart/form-data">
													<input type="hidden" class="form-control"
														name="idInstalacion"
														value="<%=request.getParameter("id_insta")%>"> <input
														type="hidden" class="form-control" name="tipoFoto"
														value="Inicial">
													<div
														class="dz-default dz-message file-dropzone text-center well col-sm-12">
														<span class="glyphicon glyphicon-paperclip"></span> <span><strong>Arrastre
																Archivo o haga click para Subir Archivo. </strong></span>
												...
												<button class="btn btn-sm btn-default m-t-n-xs"
													type="button" onClick="volveret()" tabindex="7">
													<strong><span class="fa fa-caret-left"></span>
														Volver</strong>
												</button>
											</div>
										</div>
        ...
        Dropzone.options.dropzoneForm = {
            ...
            removedfile: function(file) {
            	  var name = file.name;  
            	 ajax=objetoAjax();
 		         ajax.open("GET", 'otajax.html?accion=9&id_insta=<%=request.getParameter("id_insta")%>&tipo=Inicial&file='+name);
 		         ajax.send(null);            	  
