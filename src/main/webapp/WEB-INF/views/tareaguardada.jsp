...
<title>SAMTECH | Monitoreo de Estanques</title>
			...
			<div class="row border-bottom">
				...
				<ul class="nav navbar-top-links navbar-right">
					<li><span class="m-r-sm text-muted welcome-message">Bienvenido
							a Samtech Traslado de Vehiculos.</span></li>
							...
							<div class="ibox-content">
								<div class="row">
									...
									<div class="col-sm-12 b-r">
										<h3 class="m-t-none m-b">Tarea Guardado Exitosamente!</h3>
										<p>La tarea ha sido asignada al siguiente usuario del Flujo.</p>
	<%if(usuario.getIdRol().equals(2) || usuario.getIdRol().equals(4) ){ %>
	<a href="editartarea.html?accion=siguiente&id=<%=request.getAttribute("tarea")%>">Planificar Siguiente Tarea</a>
